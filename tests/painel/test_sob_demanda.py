"""Unidade para o backoff de `IndiceSobDemanda`.

A cotação tem arquivo próprio (`test_cotacao.py`): desde que ela passa pelo
banco, o que há para provar nela é outra coisa.
